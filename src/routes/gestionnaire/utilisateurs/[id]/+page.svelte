...
<H1Title title={'Modification de compte utilisateur'} />
...
{#if user.role_id === 4}
	<form on:submit|preventDefault={modifUtilisateur}>
        <input value="4" name="gestionnaire" hidden readonly>
        <input value="{user.id}" name="user_id" hidden readonly>
...
{#if user.role_id === 3}
	<form on:submit|preventDefault={modifUtilisateur}>
        <input value="3" name="gestionnaire" hidden readonly>
        <input value="{user.id}" name="user_id" hidden readonly>
		<div class="container is-fluid">
			{#if visible}
				<div
...
{#if user.role_id === 2}
	<form on:submit|preventDefault={modifUtilisateur}>
        <input value="2" name="gestionnaire" hidden readonly>
        <input value="{user.id}" name="user_id" hidden readonly>
		<div class="container is-fluid">
			{#if visible}
				<div
