<script>
	...
	onMount(()=>{
        ...
        if(emplacement)
            document.querySelector(`[name="${emplacement}"]`).checked = true;
        });
        ...
        if(verif)
            document.querySelector(`[name="${verif}"]`).checked = true;
        });
        if(evenement.limite)
        ...
        <div class="block">
            <div class="columns">
                ...
                <div>
                    <div class="field">
						...
						<div class="control">
							<input class="input" type="text" name="nom" id="nomEvenPayant" value="{evenement.nom}" />
						</div>
					</div>
                </div>
            ...
            <div class="my-5">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="adresse" id="adresseEvenPayant" value="{evenement.adresse}" />
                    </div>
                </div>
            </div>
            <div class="my-5">
            ...
            <div class="column is-half">
                ...
                <div>
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" type="text" name="horaire_even" id="horaireEvenPayant" value="{evenement.horaire_even}"/>
                        </div>
                    </div>
                </div>
                    ...
                    <label class="label" for="date">Dates de l'événement</label>
                      <div class="field is-grouped">
                            <div class="container ml-6 mb-3">
                                <span> Du:</span>
                                <input class="input" type="date" name="debut_even" id="dateEvenPayantDebut" on:change={dateEven} value="{evenement.debut_even}" />
                                <span>au:</span>
                                <input class="input" type="date" name="fin_even" id="dateEvenPayantFin" value="{evenement.fin_even}" />
                            </div>
                        </div>
                    </div>
...
<!-- /div du block des deux colonnes -->
            ...
            <div class="field">
                ...
                <div class="control">
                    ...
                    value="{evenement.description}" ></textarea>
                </div>
            </div>
            ...
            <div class="columns">
                ...
                <div class="my-5">
                    <div class="field">
						...
						<div class="control">
							<input class="input" type="url" name="site" id="siteEvenPayant" value="{evenement.site}"/>
						</div>
					</div>
                </div>
                 ...
                 <div class="column is-half">
                    <div class="my-5">
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="url" name="fb_even" id="siteEvenPayant" value="{evenement.fb_even}"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="column is-half">
                ...
                <div>
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" type="text" name="contact" id="contactEvenPayant" value="{evenement.contact}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-5">
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" type="courriel" name="courriel" id="courrielEvenPayant" value="{evenement.courriel}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-5">
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" type="url" name="form_cand" id="formEvenPayant" value="{evenement.form_cand}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="my-5">
                    ...
                    <div class="field is-grouped">
                        <div class="container ml-6 mb-3">
                            <span> Du:</span>
                            <input class="input" type="date" name="debut_cand" id="dateCandEvenPayantDebut" on:change={dateAppel} value="{evenement.debut_cand}"/>
                            <span>au:</span>
                            <input class="input" type="date" name="fin_cand" id="dateCandEvenPayantFin" value="{evenement.fin_cand}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                      <div class="checkboxes"> 
                          ...
                          <label class="checkbox"><input class="mr-2" type="checkbox"  id="typeAutrePayant" />Autres</label>
                          <div>
                              <input type="text" name="type_autre" id="inputTypePayant" value="{evenement.type_autre}">
                          </div>
                      </div>
                  </div>
              </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <div class="checkboxes">
                        ...
                        <label class="checkbox"><input class="mr-2" type="checkbox" id="checkboxVerifPayant"  />Autres</label>
                        <div id="divVerif">
                            <input type="text" name="verification_autre" id="inputVerifPayant" value="{evenement.verification_autre}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="columns">
            <div class="column is-half">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="number" name="nb_expo" id="nbExpoEvenPayant" value="{evenement.nb_expo}"/>
                    </div>
                </div>
            </div>
            ...
            <div class="column is-half">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="number" name="nb_visiteur" id="formEvenPayant" value="{evenement.nb_visiteur}"/>
                    </div>
                </div>
            </div>
    ...
    <div class="columns">
        <div class="column is-half">
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="number" name="fondation" id="fondation" value="{evenement.fondation}"/>
                </div>
            </div>
        </div>  
        ...
        <div class="column is-half">
            <div class="field">
                ...
                <div class="control">
                    ...
                    value="{evenement.profil}"></textarea>
                </div>
            </div>
        </div> 
