<script>
    ...
    import MenuUtilisateur from '$lib/components/menuUtilisateur.svelte';
...
<div class="columns is-hidden-mobile is-hidden-tablet-only"> <!-- Masqué sur mobile et tablette -->
